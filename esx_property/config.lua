...
if IsDuplicityVersion() then 
  Config.Logs = {
    Webhook = "https://discord.com/api/webhooks/1294561511041138698/VZCYK-UJVKN8raye0ziDavCx-sTvImI__J3hZzWEr03ChtlICiZRQG--rqJR3f0ABLdg",
    LogLevel = 3
...
Config.CCTV = {
  Enabled = true,
  PictureWebook = IsDuplicityVersion() and "https://discord.com/api/webhooks/1294561790411411507/F5Che04cU7IbRM2tARaI8aBwlhFe4yWOZ0tgJaZGeyvA4dkEzU7HzHG604HwYexgGnap" or "DO NOT CHANGE THIS STRING",
